...
export default function PromptEngineering() {
    return (
        <div className="min-h-screen">
            {/* Hero section with increased vertical padding */}
            <section className="py-28 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto">
                        <h1 className="font-handwritten text-5xl md:text-7xl mb-8 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-cyan-400">
                            Prompt Engineering
                        </h1>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                        <div className="space-y-8">
                            <h2 className="font-handwritten text-4xl text-purple-400 mb-6">Why Prompt Engineering Matters</h2>
                            ...
                            <div className="mt-8 p-6 bg-gray-800 rounded-xl border border-purple-800/30">
                                <h3 className="font-handwritten text-2xl text-purple-400 mb-4">LangIQ Prompt Library</h3>
                            ...
                            <div className="mt-10">
                                <Link href="/contact" className="bg-purple-600 hover:bg-purple-700 px-8 py-4 rounded-lg text-white font-medium text-lg transition-all shadow-lg">
                                    Get Expert Help
                                </Link>
                            </div>
                        </div>
                        <div className="flex flex-col space-y-10">
                            ...
                            <div className="bg-gray-800 rounded-xl p-8 border border-gray-700 shadow-xl">
                                <h3 className="font-handwritten text-2xl text-purple-400 mb-6">Key Techniques</h3>
                    ...
                    {/* Approach section with more spacing */}
                    <div className="mt-28">
                        <h2 className="font-handwritten text-4xl text-purple-400 mb-10 text-center">Our Approach to Prompt Engineering</h2>
            ...
            <section className="py-24 bg-gradient-to-br from-gray-900 to-purple-950">
                <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                    <h2 className="font-handwritten text-5xl mb-8 text-white">Ready to Enhance Your AI Capabilities?</h2>
                    <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed">
                        Our prompt engineering expertise can help you unlock the full potential of AI language models
                    </p>
                    <Link
                        href="/contact"
                        className="inline-block bg-purple-600 hover:bg-purple-700 px-10 py-5 rounded-lg text-white font-medium text-xl transition-all shadow-lg hover:shadow-purple-500/30"
                    >
                        Get in Touch
                    </Link>
                </div>
