...
*Note: Values represent averages across multiple studies and may vary by implementation.*
...
## References
1. Karpukhin, V., Oguz, B., Yazici, A., & Vinyals, O. (2020). Dense passage retrieval for open-domain question answering. *Proceedings of the 43rd International ACM SIGIR Conference on Research and Development in Information Retrieval*.
2. Lewis, M., Oguz, B., Riedel, S., & Cohn, T. (2020). Retrieval-augmented generation for knowledge-intensive NLP tasks. *arXiv preprint arXiv:2005.11401*.
3. Swartout, W., & Moore, J. (2014). The role of grounding in the development of an intelligent agent. *Artificial Intelligence*, 206, 9-30.
4. Gao, J., Galley, M., & Li, L. (2019). Neural approaches to conversational AI. *Foundations and Trends in Information Retrieval*, 13(2-3), 127-298.
...
6. Izacard, G., & Grave, E. (2021). Leveraging passage retrieval with generative models for open domain question answering. *Proceedings of the 16th Conference of the European Chapter of the Association for Computational Linguistics*.
7. Ram, P., Shen, Y., Nogueira, R., Gupta, N., Padmakumar, V., & Zhang, D. (2022). One embedder, any task: Instruction-finetuned text embeddings. *arXiv preprint arXiv:2212.09741*.
8. Borgeaud, S., Mensch, A., Hoffmann, J., Cai, T., Rutherford, E., Millican, K., ... & Sifre, L. (2022). Improving language models by retrieving from trillions of tokens. *International Conference on Machine Learning*.
9. Khattab, O., Santhanam, K., Li, X., Hall, D., Liang, P., Potts, C., & Zaharia, M. (2023). Demonstrating DSPy: Compiling Foundation Models for Reasoning through Self-Improvement. *Proceedings of the 2023 Conference on Empirical Methods in Natural Language Processing: System Demonstrations*.
10. Liu, N. F., Lin, K., Hewitt, J., Paranjape, A., Bevilacqua, M., Petroni, F., & Liang, P. (2023). Lost in the middle: How language models use long contexts. *arXiv preprint arXiv:2307.03172*.
11. Asai, A., Wu, Z., Agarwal, Y., Yang, Y., & Zettlemoyer, L. (2023). Self-RAG: Learning to retrieve, generate, and critique through self-reflection. *arXiv preprint arXiv:2310.11511*.
12. Si, C., Chen, Z., Gan, Z., Chen, W., Wang, S., Wang, W. Y., & Liu, Z. (2023). Prompting large language models with chain-of-thought for few-shot knowledge-based visual question answering. *arXiv preprint arXiv:2306.05212*.
13. Nakano, R., Hilton, J., Balaji, S., Wu, J., Ouyang, L., Kim, C., ... & Schulman, J. (2022). WebGPT: Browser-assisted question-answering with human feedback. *arXiv preprint arXiv:2112.09332*.
14. Menick, J., Trebacz, M., Mikulik, V., Aslanides, J., Song, F., Chadwick, M., ... & McAleese, N. (2022). Teaching language models to support answers with verified quotes. *arXiv preprint arXiv:2203.11147*.
15. Lin, J., Ma, X., Lin, S.-C., Yang, J.-H., Guo, R., & Murray, W. R. (2021). Towards comprehensive multi-document summarization of medical literature for systematic review generation. *Findings of the Association for Computational Linguistics: EMNLP 2021*.
16. Ren, H., Yang, W., Lin, Y., Wang, D., Perez, E., Nie, A., Liu, A., Zhang, B., McCallum, A., & O'Connor, A. (2023). Languages models can explain neurons in large language models. *arXiv preprint arXiv:2309.10253*.
17. Lazaridou, A., Gribovskaya, E., Stokowiec, W., & Grigorev, N. (2022). Internet-augmented language models through few-shot prompting for open-domain question answering. *arXiv preprint arXiv:2203.05115*.
