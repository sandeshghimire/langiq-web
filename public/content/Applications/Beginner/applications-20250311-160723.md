...
def create_rag_chain(vector_store):
    ...
    the answer, say "I don't have enough information to answer this question." Include relevant
    citations from the source documents in your answer.
    """
            ...
            with st.spinner("Generating response..."):
                ...
                with st.expander("Sources"):
                    for i, source in enumerate(response["sources"]):
                        st.markdown(f"**Source {i+1}:** {source.get('source', 'Unknown')}, Page: {source.get('page', 'N/A')}")
        else:
