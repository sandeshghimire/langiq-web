export const DATALOGGER_PROBLEM = {
    ...
    failureModes: [
        {
            label: '11 sensors standard — siliconcentric-Logger-Base',
            description:
                'Every board ships with the siliconcentric-Logger-Base: shock, vibration, temperature, humidity, light, sound, pressure, GPS, gyroscope, IMU, and magnetometer — 11 sensors as the standard foundation. [Founder decision: GPS may be optional, making the base 10 sensors. Confirm before publishing.]',
        },
        {
