    ...
    return (
        <div id="middleware" className="p-8 border-t border-gray-200">
            ...
            <ul className="text-gray-700 space-y-2 ml-4">
                ...
                <li><strong>MQTT</strong>: Eclipse Mosquitto broker optimized for Zynq, AWS IoT Core integration with hardware security, MQTT-SN for low-power sensors, custom MQTT-to-DDS bridge implementations</li>
