export default function About() {
    return (
        <div className="px-6 py-6 md:px-8 md:py-8 border-t border-gray-200">
            <h1 className="text-2xl font-bold text-black mb-4 uppercase animate-fadeInUp">About Me</h1>

            <p className="text-gray-700 leading-relaxed mb-4 animate-fadeInUp stagger-1">
            ...
            <h2 className="text-xl font-semibold text-black mb-3 uppercase tracking-wide animate-fadeInUp stagger-2">Core Expertise Areas:</h2>
            ...
            <h2 className="text-xl font-semibold text-black mb-3 uppercase tracking-wide animate-fadeInUp stagger-3">Platform Experience</h2>
            <p className="text-gray-700 leading-relaxed mb-4 animate-fadeInUp stagger-3">
            ...
            <h2 className="text-xl font-semibold text-black mb-3 uppercase tracking-wide animate-fadeInUp stagger-4">Consulting Approach</h2>
