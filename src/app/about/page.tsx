export default function About() {
    return (
        <div className="p-8 border-t border-gray-200">
            <h1 className="text-2xl font-bold text-black mb-6 uppercase animate-fadeInUp">About Me</h1>
            ...
            <h2 className="text-xl font-semibold text-black mb-4 uppercase tracking-wide animate-fadeInUp stagger-2">Core Expertise Areas:</h2>
            ...
            <h2 className="text-xl font-semibold text-black mb-4 uppercase tracking-wide animate-fadeInUp stagger-3">Platform Experience</h2>
            <p className="text-gray-700 leading-relaxed mb-6 animate-fadeInUp stagger-3">
            ...
            <div className="text-gray-700 mb-6">
                <p className="mb-3 animate-fadeInUp stagger-4 hover:translate-x-2 transition-smooth"><strong><a href="/amd-xilinx-zynq" className="text-blue-600 hover:text-blue-800 underline">AMD Xilinx Zynq</a></strong> - Programmable SoC platforms combining FPGA fabric with ARM processors for heterogeneous computing solutions.</p>
                <p className="mb-3 animate-fadeInUp stagger-4 hover:translate-x-2 transition-smooth"><strong><a href="/nvidia-jetson" className="text-blue-600 hover:text-blue-800 underline">NVIDIA Jetson</a></strong> - AI-enabled embedded computing platforms with GPU acceleration for edge computing and AI applications.</p>
                <p className="mb-3 animate-fadeInUp stagger-5 hover:translate-x-2 transition-smooth"><strong><a href="/nxp-imx" className="text-blue-600 hover:text-blue-800 underline">NXP i.MX</a></strong> - High-performance application processors optimized for multimedia, industrial, and automotive applications.</p>
                <p className="mb-3 animate-fadeInUp stagger-5 hover:translate-x-2 transition-smooth"><strong><a href="/raspberry-pi" className="text-blue-600 hover:text-blue-800 underline">Raspberry Pi</a></strong> - Versatile single-board computers ideal for prototyping, IoT projects, and production embedded systems.</p>
            </div>

            <h2 className="text-xl font-semibold text-black mb-4 uppercase tracking-wide animate-fadeInUp stagger-4">Consulting Approach</h2>
            <p className="text-gray-700 leading-relaxed animate-fadeInUp stagger-5">
