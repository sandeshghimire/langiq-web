    ...
    return (
        <div id="middleware" className="p-8 border-t border-gray-200">
            ...
            <p className="text-gray-700 leading-relaxed font-normal mb-4">
                LangIQ develops tailored middleware solutions optimized for AMD Xilinx Zynq platforms, leveraging dual-core ARM Cortex-A9 processors and integrated FPGA fabric for high-performance embedded applications requiring deterministic real-time communication.
            </p>
