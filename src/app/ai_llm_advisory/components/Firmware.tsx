    ...
    return (
        <div id="firmware" className="p-8 border-t border-gray-200">
            ...
            <p className="text-gray-700 leading-relaxed font-normal mb-4">
                LangIQ delivers comprehensive firmware solutions for AMD Xilinx Zynq MPSoC R series microcontrollers, specializing in RTOS implementation, inter-processor communication, and real-time system development for mission-critical applications.
            </p>
