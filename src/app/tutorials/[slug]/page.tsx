...
export default function TutorialPage() {
    ...
    const { theme } = useTheme(); // Actually use the theme hook
                        ...
                        <div className={`${headings.length > 0 ? 'lg:w-3/4' : 'w-full'} order-1 lg:order-2`}>
                            ...
                            <div className="content-box p-6 mt-8 print:hidden">
                                ...
                                <div className="flex flex-wrap justify-between items-center gap-4">
                                    <Link href="/applications" className="handwriting bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-full transition-colors">
