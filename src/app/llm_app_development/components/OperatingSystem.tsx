    ...
    return (
        <div id="operating-system" className="p-8 border-t border-gray-200">
            ...
            <p className="text-gray-700 leading-relaxed font-normal mb-4">
                LangIQ leverages Yocto Project for AMD Xilinx Zynq platform development, focusing on meta-xilinx layer integration, custom recipe creation, and bitbake optimization. Core activities include BSP layer management, FSBL/U-Boot integration, device tree customization, FPGA bitstream handling, and automated build workflows for ARM Cortex-A + FPGA hybrid architectures.
            </p>
