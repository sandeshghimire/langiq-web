...
export default function Home() {
    ...
    const services = [
        ...
        "LangIQ empowers organizations with AI-driven decision intelligence that transforms raw data into actionable insights. Our advanced analytics platforms combine machine learning with strategic business intelligence to provide clear, data-backed recommendations for critical decisions. Through sophisticated pattern recognition, predictive modeling, and real-time analytics, we help enterprises navigate complex choices with confidence, ensuring every strategic decision is supported by comprehensive data analysis and AI-powered insights.",
        ""
