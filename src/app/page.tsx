export default function Home() {
  return (
    <div>
      ...
      <div className="px-6 py-6 md:px-8 md:py-8 border-t border-gray-200 animate-fadeInUp stagger-1">
        <h2 className="text-xl font-semibold text-black mb-3 uppercase tracking-wide">About Soccentric</h2>
        ...
        <h3 className="text-lg font-semibold text-black mb-2 uppercase tracking-wide animate-fadeInUp stagger-2">Our Core Services:</h3>
        <ul className="text-gray-700 space-y-1.5 ml-4 mb-4">
        ...
        <h3 className="text-lg font-semibold text-black mb-2 uppercase tracking-wide animate-fadeInUp stagger-3">Platforms We Support:</h3>
        <ul className="text-gray-700 space-y-1.5 ml-4 mb-4">
