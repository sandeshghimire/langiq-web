    ...
    <div>
      ...
      <div className="p-8 border-t border-gray-200">
        ...
        <ul className="text-gray-700 space-y-2 ml-4 mb-6">
          <li><strong>Hardware Development:</strong> We specialize in custom hardware design and architecture for platforms including <a href="/amd-xilinx-zynq#hardware" className="text-blue-600 hover:text-blue-800 underline">AMD Xilinx Zynq</a>, <a href="/nvidia-jetson#hardware" className="text-blue-600 hover:text-blue-800 underline">NVIDIA Jetson</a>, <a href="/nxp-imx#hardware" className="text-blue-600 hover:text-blue-800 underline">NXP i.MX</a>, and <a href="/raspberry-pi#hardware" className="text-blue-600 hover:text-blue-800 underline">Raspberry Pi</a>, from initial concept through production. Our services include schematic capture, PCB layout design, board bring-up, and custom enclosure design featuring both active and passive cooling solutions tailored to your application requirements.</li>
          <li><strong>Operating System Development:</strong> We develop Linux-based custom operating systems using the Yocto build environment for <a href="/amd-xilinx-zynq#operating-system" className="text-blue-600 hover:text-blue-800 underline">AMD Xilinx Zynq</a>, <a href="/nvidia-jetson#operating-system" className="text-blue-600 hover:text-blue-800 underline">NVIDIA Jetson</a>, <a href="/nxp-imx#operating-system" className="text-blue-600 hover:text-blue-800 underline">NXP i.MX</a>, and <a href="/raspberry-pi#operating-system" className="text-blue-600 hover:text-blue-800 underline">Raspberry Pi</a> platforms. Our team optimizes kernels for specific architectures and implements PREEMPT_RT patches for real-time performance critical applications.</li>
          <li><strong>Driver Development:</strong> We create custom Linux-based drivers for a wide range of devices including IMUs, cameras, displays, motor controllers, and other specialized peripherals across <a href="/amd-xilinx-zynq#drivers" className="text-blue-600 hover:text-blue-800 underline">AMD Xilinx Zynq</a>, <a href="/nvidia-jetson#drivers" className="text-blue-600 hover:text-blue-800 underline">NVIDIA Jetson</a>, <a href="/nxp-imx#drivers" className="text-blue-600 hover:text-blue-800 underline">NXP i.MX</a>, and <a href="/raspberry-pi#drivers" className="text-blue-600 hover:text-blue-800 underline">Raspberry Pi</a> platforms to ensure seamless hardware-software integration.</li>
          <li><strong>Middleware Solutions:</strong> We customize and integrate various middleware solutions including DDS (Data Distribution Service), ROS1/ROS2, Protocol Buffers, MQTT, and other communication protocols optimized for <a href="/amd-xilinx-zynq#middleware" className="text-blue-600 hover:text-blue-800 underline">AMD Xilinx Zynq</a>, <a href="/nvidia-jetson#middleware" className="text-blue-600 hover:text-blue-800 underline">NVIDIA Jetson</a>, <a href="/nxp-imx#middleware" className="text-blue-600 hover:text-blue-800 underline">NXP i.MX</a>, and <a href="/raspberry-pi#middleware" className="text-blue-600 hover:text-blue-800 underline">Raspberry Pi</a> platforms to meet your system's specific requirements.</li>
          <li><strong>Application Development:</strong> We develop custom applications across diverse industries including robotics, automotive, medical devices, defense, and aerospace sectors, leveraging <a href="/amd-xilinx-zynq#application-development" className="text-blue-600 hover:text-blue-800 underline">AMD Xilinx Zynq</a>, <a href="/nvidia-jetson#application-development" className="text-blue-600 hover:text-blue-800 underline">NVIDIA Jetson</a>, <a href="/nxp-imx#application-development" className="text-blue-600 hover:text-blue-800 underline">NXP i.MX</a>, and <a href="/raspberry-pi#application-development" className="text-blue-600 hover:text-blue-800 underline">Raspberry Pi</a> platforms, ensuring solutions that meet stringent industry standards and requirements.</li>
        </ul>
