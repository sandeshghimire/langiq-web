    ...
    return (
        <div id="drivers" className="p-8 border-t border-gray-200">
            ...
            <p className="text-gray-700 leading-relaxed font-normal mb-4">
                LangIQ develops custom device drivers for AMD Xilinx Zynq platform peripherals using Yocto Project integration. Driver development covers communication interfaces (SPI, I2C, UART, Ethernet), video systems (MIPI, HDMI, cameras), sensors (IMU, temperature, ADC), GPIO control, USB connectivity, and specialized hardware including transceivers and motor controllers for embedded applications.
            </p>
