    ...
    return (
        <div id="drivers" className="p-8 border-t border-gray-200">
            ...
            <ul className="text-gray-700 space-y-3 ml-4">
                <li><strong>Communication Interface Drivers</strong> - UART (multiple instances), SPI/I2C controllers, FlexCAN, Ethernet MAC (10/100/1000 Mbps), WiFi 802.11ac/ax, Bluetooth 5.0/LE, USB 2.0/3.0 OTG, PCIe controllers, and FlexSPI with interrupt handling and DMA support</li>
