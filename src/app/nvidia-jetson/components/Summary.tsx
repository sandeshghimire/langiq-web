export default function Summary() {
    return (
        <div className="p-8 border-t border-gray-200">
            <h1 className="text-xl font-bold text-black mb-2 uppercase">NVIDIA Jetson</h1>
            <p className="text-gray-700 leading-relaxed font-normal mb-6">

                NVIDIA Jetson is a System-on-Module platform combining ARM processors with powerful GPU acceleration and dedicated AI processing units. The platform delivers exceptional AI inferencing performance with CUDA cores, Tensor cores, and specialized AI engines for computer vision, machine learning, and autonomous systems. This architecture enables high-performance edge AI applications including robotics, autonomous vehicles, smart cities, and industrial AI automation.
            </p>
